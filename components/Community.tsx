  ...
  return (
    <div className="h-full overflow-y-auto">
        ...
        <div className="relative h-[40vh] w-full flex items-center justify-center overflow-hidden border-b border-white/10">
            {/* User Pick 7: Photographer with big lens in field */}
            <img src={IMAGES.KONSTA.FIELD_LENS} className="absolute inset-0 w-full h-full object-cover opacity-40 grayscale" />
